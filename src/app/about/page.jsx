  ...
  return (
    ...
    >
      ...
      <div className="h-full lg:flex justify-center">
        {/* TEXT CONTAINER */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-20 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0">
          {/* BIOGRAPHY CONTAINER */}
          ...
          <div
            className="flex flex-col gap-12 justify-center pb-64 md:pb-32"
            ref={experienceRef}
          >
            {/* EXPERIENCE TITLE */}
            <motion.h1
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  I teach data structures, algorithms, and network programming
                  to 100+ students.{" "}
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    I led a team of 8 developers using Agile to organize
                    data science hackathons for 500+ attendees and 10+ sponsors.{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2022 - 2024{" "}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                  I addressed diverse technical issues, resolving 2,000+ tickets using ServiceNow.{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2023 - 2024
